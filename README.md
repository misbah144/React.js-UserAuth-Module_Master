...
User Authentication module is designed to be quick to setup. You'll need an account with Auth0 or Netlify Identity and the appropriate access keys.
...
User Authentication module  does not install its own authentication clients. Instead they're marked as peer dependencies.
...
User Authentication module  uses an `<AuthConfig>` component to configure your authentication client. We use XState behind the scenes to manage authentication state for you.
...
User Authentication module client wrappers provide smart defaults.
...
You're ready to use User Authentication module for authentication in your React app. 🤘
